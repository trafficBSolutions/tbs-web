...
const WorX = () => {
  ...
  return (
    ...
    <source src="../public/MX/mx pic.mp4" type="video/mp4"></source></video>
            ...
            <form className="custom-sign-form -- material-box">
              <div className="custom-sign">
                ...
                {isSignDropdownOpen && (
                  ...
                  <img className="custom-sign-img" alt="Custom signage" src="../public/MX/btr.jpg" />
                  <img className="custom-sign-img" alt="Custom signage" src="../public/MX/trinity.jpg" />
                  <img className="custom-sign-img" alt="Custom signage" src="../public/MX/shaw.jpg" />
                    </div>
                ...
                {isDecalDropdownOpen && (
                  <div className="custom-sign-dropdown">
                    <h2 className="custom-decal-h2">
                      ...
                      <img className ="custom-decal-img" alt="Custom signage" src="../public/MX/yancy.jpg"/>
                      <img className="custom-decal-img" alt="Custom signage" src="../public/MX/A Plus.jpg"/>
                      <img className="custom-decal-img" alt="Custom signage" src="../public/MX/box truck.jpg"/>
                      <div className="material-video-banner">
...
displayed in indoor or outdoor settings, making them an effective tool for conveying information and capturing the interest of passersby.
                      ...
                      <img className ="custom-banner-img3" alt="Custom signage" src="../public/MX/Banner BBQ.JPG"/>
                      <img className ="custom-banner-img" alt="Custom signage" src="../public/MX/mallory.jpg"/>
                      <img className ="custom-banner-img2" alt="Custom signage" src="../public/MX/mallory2.jpg"/>
                      </div>
                    </h2>
              ...
              <div className="custom-tshirts">
                ...
                {isTShirtDropdownOpen && (
                  <div className="custom-sign-dropdown">
                    ...
                    <img className ="custom-shirt-img" alt="Custom signage" src="../public/MX/jdf shirt.jpg"/>
...
ensuring comfort and functionality across diverse settings.
                ...
                {isDrywallDropdownOpen && (
                  <div className="custom-sign-dropdown">
                    ...
                    <div className="drywall-vinyl-container">
                        <img className ="custom-drywall-img" alt="Custom signage" src="../public/MX/Nance.JPG"/>
                        <img className ="custom-drywall-img2" alt="Custom signage" src="../public/MX/Nance 2.JPG"/>
    ...
    <h1 className="contact-materialX">
        To request for any of the products or services shown above, please contact us:
    </h1>
</div>
...
<div className="will-contact-link">
    <h1 className="will-contact">
        MANUFACTURER: WILLIAM ROWELL: <a className="will-phone" href="tel:+17068790106">706-879-0106</a> or <a className="will-email" href="mailto:tbsolutions9@gmail.com">tbsolutions9@gmail.com</a>
    </h1>
</div>
