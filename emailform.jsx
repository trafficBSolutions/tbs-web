...
const Email = () => {
    ...
    position: sticky;
    transform: scale(0.3);"
    href="www.trafficbarriersolutions.com">
        <img alt="TBS logo" src="public/TBS logo1.png" />
        </a>
        <h1 style="
        font-size: 48px;
        text-align: center;
        ...
        padding: 8px;
        color:#000000;
        ">TRAFFIC & BARRIER SOLUTIONS, LLC</h1>
        ...
        <h2 style="margin-top: 20px;
                ...
                <div style="padding-top: 10px;">
                    ...
                    <h1 style= "font-family: 'Moveo Sans w00 Regular';"
                    >Bryson C Davis</h1>
                    <h1 style= "font-family: 'Moveo Sans w00 Regular';"
                    ...
                    <h1 style= "font-family: 'Moveo Sans w00 Regular';">Website: <a href="http://www.trafficbarriersolutions.com">www.trafficbarriersolutions.com</a></h1>
                </div>
                </div>
...
<div className="equipment-section">
      ...
      <div className="equipment-section">
        ...
        <DatePicker
          selected={endDate}
          placeholderText="Select a End Date/Time"
